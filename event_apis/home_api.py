...
class CCHomeApi:
    ...
    async def init_session(self):
        async with ClientSession() as session:
            await session.get(f'{self.server_url}/event/regress_v2', params=self.default_params, timeout=timeout)
            ...
            for i in range(5):
                try:
                    ...
                    headers = {
                        ...
                        'Referer': f'https://event-eu-cc.igg.com/event/regress_v2/?g_id={GAME_ID}&signed_key={self.signed_key}&uid={self.igg_id}'
                    }
